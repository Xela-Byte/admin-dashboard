...
const page = (props: Props) => {
  const [userTab, setUserTab] = useState<string>("list");
    ...
    <div className="w-screen lg:w-full px-2">
      <div className="w-full h-20 my-5 px-3 lg:px-10 lg:w-2/3 2xl:w-2/3 space-x-5 flex items-center justify-between">
        <button
          ...
          <div
            className={`w-full h-1 ${userTab === "list" && "bg-gray-500"}`}
          />
        </button>
        <button
          type="button"
          aria-label="datauserTab"
          onClick={() => {
            setUserTab("data");
          }}
          className="w-1/2 space-y-3 lg:space-y-5 flex flex-col items-center justify-center">
          <p className="text-lg lg:text-2xl font-medium">Data User Clients</p>
          <div
